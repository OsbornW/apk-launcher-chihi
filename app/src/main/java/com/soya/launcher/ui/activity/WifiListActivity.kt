...
import com.soya.launcher.ui.fragment.AbsWifiListFragment
import com.soya.launcher.ui.fragment.ScaleScreenFragment.Companion.newInstance
import com.soya.launcher.ui.fragment.WifiListFragment

class WifiListActivity : BaseWallpaperActivity<ActivityMainBinding, BaseViewModel>() {

    override fun initView() {
        replaceFragment(AbsWifiListFragment(), R.id.main_browse_fragment)
    }
