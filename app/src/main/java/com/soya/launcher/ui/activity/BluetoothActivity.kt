...
class BluetoothActivity : BaseWallpaperActivity<ActivityMainBinding, BaseViewModel>() {

    override fun initView() {
        replaceFragment(BluetoothFragment.newInstance(), R.id.main_browse_fragment)
    }
}
