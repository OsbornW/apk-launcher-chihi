package com.chihihx.launcher.handler;
...
public class PermissionHandler {
    ...
    public static final String[] PERMISSIONS_API33 = {
    ...
    public static String[] getPermissions(){
        return Build.VERSION.SDK_INT <= Build.VERSION_CODES.S_V2 ? PERMISSIONS : PERMISSIONS_API33;
    }
