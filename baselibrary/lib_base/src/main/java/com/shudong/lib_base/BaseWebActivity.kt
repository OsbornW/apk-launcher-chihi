...
open class BaseWebActivity : BaseVMActivity<ActivityBaseWebBinding, BaseViewModel>() {
    ...
    override fun initView() {
        ...
        url = when (Locale.getDefault().language) {
            ...
            "de"->"file:///android_asset/privacy_policy_de.html"
            "es"->"file:///android_asset/privacy_policy_es.html"
            "ja"->"file:///android_asset/privacy_policy_jar.html"
            "pt"->"file:///android_asset/privacy_policy_pt.html"
