...
import com.thumbsupec.ispruz.wheel_picker.R;
...
public abstract class BaseWheelLayout extends LinearLayout implements OnWheelChangedListener {
    ...
    public BaseWheelLayout(Context context) {
        super(context);
        init(context, null, com.thumbsupec.ispruz.wheel_view.R.attr.WheelStyle, com.thumbsupec.ispruz.wheel_view.R.style.WheelDefault);
    }

    public BaseWheelLayout(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, com.thumbsupec.ispruz.wheel_view.R.attr.WheelStyle, com.thumbsupec.ispruz.wheel_view.R.style.WheelDefault);
    }

    public BaseWheelLayout(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs, defStyleAttr, com.thumbsupec.ispruz.wheel_view.R.style.WheelDefault);
    }
    ...
    public void setStyle(@StyleRes int style) {
        initAttrs(getContext(), null, com.thumbsupec.ispruz.wheel_view.R.attr.WheelStyle, style);
        requestLayout();
        invalidate();
    }
